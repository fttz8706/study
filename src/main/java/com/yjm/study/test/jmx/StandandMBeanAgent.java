package com.yjm.study.test.jmx;

import com.sun.jdmk.comm.HtmlAdaptorServer;
import com.yjm.study.test.jmx.standand.Hello;
...
//        standandMBean();
    ...
    private static void standandMBean() throws Exception {
        ...
        final ObjectName objectName = new ObjectName("com.yjm.study.test.jmx:name=hello world");
    ...
    private static void htmlAdaptorServer() throws Exception {
        ...
        ObjectName helloName = new ObjectName("com.yjm.study.test.jmx:name=hello bean");
        mBeanServer.registerMBean(new Hello(), helloName);

        ObjectName adapterName = new ObjectName("com.yjm.study.test.jmx:name=adapter bean, port=8999");
